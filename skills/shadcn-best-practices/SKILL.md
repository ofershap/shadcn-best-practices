...
description: shadcn/ui done right. Component customization, form patterns, theming, accessibility, and composition patterns.
metadata:
...
**Wrong:**
```tsx
<form onSubmit={(e) => { e.preventDefault(); /* manual validation */ }}>
...
**Wrong:**
```tsx
<div onClick={() => setOpen(!open)} role="button">...</div>
```

**Correct:**
```tsx
import * as Dialog from "@radix-ui/react-dialog"
<Dialog.Root><Dialog.Trigger>...</Dialog.Trigger>...</Dialog.Root>
```
